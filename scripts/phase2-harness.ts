...
import { FullWindowSamples, type EpisodeEvidence, type TrajectoryRecord } from './phase2-analysis';
...
export function runTrajectory(spec: TrajectorySpec, allTimings?: FullWindowSamples, recordTape = false) {
