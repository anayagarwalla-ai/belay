...
Incomplete partial evidence: 0/1000 validated trajectory records. Four local workers; no aggregate claim from missing ordinals.

Evidence status: **INCOMPLETE**.

Generated 2026-09-07T23:39:10.711Z. Mode: **full**. Source manifest: `f437b0fd87a24ff2c2828c2f452dac14a686693bb4227f3b8495a9b9c6df04ce`.
...
Observed 0 trajectories: 0 crossing trajectories; 0 crossing completions; 0 physical terminal failures across both scenes; 0 focused-fixture recoveries; 0 administrative timeouts; 0 errors. 0 records have incomplete evidence. A focused recovery is not a completed glacier run.
...
Across both deliberately different scenes, eventual episode recovery is unknown (0/0), with 0 unresolved episodes. First-attempt recovery is unknown (0/0). These aggregate mixtures are descriptive, not a population or human success rate; use the scene/team/policy strata.

## Timing and missing outcomes

Successful episode duration: p50 unknown s, p95 unknown s, n=0. Unresolved rescue observations: n=0; their observation limits are not success durations.

Completed crossing duration: median unknown s, n=0. Any terminal crossing outcome: median unknown s, n=0. Descriptive censor-aware time-to-terminal median: unknown s; independent censoring is not established.

First fall among observed falls: median unknown s, n=0; 0 trajectories have no observed incident. The raw file retains those exposures and outcomes. Focused rescue starts at a supplied hazard and is not natural first-incident pacing.
...
Worst observed span excess unknown m; segment excess unknown m; terrain penetration unknown m; body overlap unknown m. The raw records retain each scene/seed/policy and the energy/work diagnostics. These maxima are measurements, not an assertion that the mechanical bounds passed.

Exact nearest-rank quantiles over validated persisted raw timing prefixes only; interrupted/unflushed attempts may be absent. Sample count=0; p50=unknown ms, p95=unknown ms, p99=unknown ms, max=unknown ms. 0 persisted samples versus 0 validated record step attempts. No full-window completeness claim; missing, corrupt or unflushed tails remain unknown. No recent-sample ring or mean of quantiles is used.
...
Run from the repository root with `node --import tsx scripts/phase2-parallel.ts --plan` to inspect the plan, or `node --import tsx scripts/phase2-parallel.ts --run` to start a new four-worker invocation. Replay and stress remain separate bounded workloads. Historical reports are unchanged.
