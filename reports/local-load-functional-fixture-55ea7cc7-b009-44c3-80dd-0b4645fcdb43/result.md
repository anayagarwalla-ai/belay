...
Full-window offered lateness p50/p95/p99/max (ms): 0.599 / 1.180 / 1.439 / 1.822. Raw lossless planes and the deterministic schedule are in JSON; nearest-rank definition is included. Audit: all scheduled slots reconcile.
...
|---|---:|---:|---:|---:|---:|
| xUuG54EbC | 1.991 | 1.862 | 2.808 | 0.000 | 0.000 |
| Z5sxK85YC | 1.480 | 1.807 | 2.810 | 0.000 | 0.000 |
...
Observed owned-process RSS peak: 560.0 MiB. This includes the controller and separate child processes. NOT RUN: no exact JS/native/WASM ownership attribution. Post-disposal memory growth is observational; allocator retention, GC timing and reachable leaks are not distinguished.

| Empty authority observation | Live rooms | Process RSS MiB | Heap used MiB | External MiB |
|---|---:|---:|---:|---:|
| initialized-empty-baseline | 0.000 | 219.3 | 30.6 | 12.0 |
| after-create-dispose-cycle 0 | 0.000 | 219.5 | 31.2 | 12.0 |
| after-create-dispose-cycle 1 | 0.000 | 219.6 | 31.7 | 12.0 |
| after-full-population-disposal | 0.000 | 233.1 | 38.7 | 12.7 |
