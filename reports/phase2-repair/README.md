...
Participation counts an input-driven loaded movement, actual self-contributed slack take-up, an active climb, a changed loaded input, or a planted loaded catch while a casualty is falling. Passive dragging is not active participation; stationary brace after the catch is not an active rescue role. This is a mechanical proxy, not a human decision or fun measurement. It differs from the historical proxy and must not be pooled with it.
